  ...
  return (
    <footer className="relative bg-[#141A31] text-white">
      <div className="relative">
        <img src={img1} alt="" className="absolute top-0 left-0 w-full h-full object-cover opacity-10" />
        <img src={img2} alt="" className="absolute top-0 right-0 w-full h-full object-cover opacity-10" />
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          <div className="text-center mb-8">
            <h5 className="text-2xl font-bold mb-4">don't miss out, join now for early access</h5>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <ul className="flex flex-wrap justify-center gap-6">
              <li>
                <Link to="#" className="text-gray-400 hover:text-[#14C2A3] transition-colors">Privacy Policy</Link>
              </li>
              <li>
                <Link to="#" className="text-gray-400 hover:text-[#14C2A3] transition-colors">Cookies</Link>
              </li>
              <li>
                <Link to="#" className="text-gray-400 hover:text-[#14C2A3] transition-colors">Terms & Conditions</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-[#14C2A3] transition-colors">Contact Us</Link>
              </li>
            </ul>
          </div>
        </div>
